...
app.get("/burger" , (req , res) => {
    res.json([
        ...
        },
        {
            ...
            price: 69.52,
            description: "The World's favourite Indian burger! A crispy Aloo patty, tomato mayo sauce & ... read more",
            qty: 1,
        },
        {
            id : 3,
        ...
        },
        {
            ...
            price: 224.19,
            description: "Savor our filling 11 layer burger! Double the indulgence with 2 corn & ... read more",
            qty: 1,
        },
        {
            id : 7,
...
app.get("/pizza" , (req , res) => {
    res.json([
        ...
        },
        {
            ...
            price: 319,
            description: "Our signature pan sauce, with BBQ Sauce drizzle, topped with mushroom, onion, green capsicum, & red paprika",
            qty: 1,
        },
        {
            id: 4,
